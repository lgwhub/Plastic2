...
#include <includes.h>
   ...
   extern void InitUSART1(unsigned long int baud_rate,unsigned short int parity);
#elif  OS_VIEW_USART_NUMBER == 2
   extern void InitUSART2(unsigned long int baud_rate,unsigned short int parity);
#elif  OS_VIEW_USART_NUMBER == 3
   extern void InitUSART3(unsigned long int baud_rate,unsigned short int parity);
#endif
...
//#elif (OS_VIEW_USART == USART2)

//#elif (OS_VIEW_USART  == USART3)
	

#if   OS_VIEW_USART_NUMBER == 1
		InitUSART1(baud_rate,USART_Parity_No);
#elif  OS_VIEW_USART_NUMBER == 2
		InitUSART2(baud_rate,USART_Parity_No);
#elif  OS_VIEW_USART_NUMBER == 3
		InitUSART3(baud_rate,USART_Parity_No);
#endif 
